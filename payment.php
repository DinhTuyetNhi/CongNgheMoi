        ...
        paypal.Buttons({
            ...
            onApprove: function(data, actions) {
                 return actions.order.capture().then(function(details) {
                    alert('Thanh toán hoàn tất bởi ' + details.payer.name.given_name);
                    window.location.href = "server/complete_payment.php?order_id=<?php echo $order_id; ?>&redirect=shipcod";
                });
            }
